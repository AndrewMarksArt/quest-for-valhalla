...
export default function InfoSection() {
    const tweet = 'I just signed up for early access! ⚔️🛡️\n\nCome check out this upcoming P2E tactics game 🎮, follow @BattleVikingNFT for a chance to win a legendary Golden Quest!🏆\n\nhttps://twitter.com/andrewmarksart/status/1636919962827649026/photo/1';
    const hashtags = 'BeTheWarrior,NFTs,ETH,P2EGame';
